    ...
    <>
      ...
      <section className="py-16 bg-white text-gray-900">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            <h3 className="text-lg font-bold mb-3 font-[family-name:var(--font-days-one)]">
              Before & After
            </h3>
            <p className="text-sm text-gray-500 mb-4 font-[family-name:var(--font-syne)]">
              Drag the slider to see the repair results.
            </p>
            <BeforeAfterSlider
              before="/images/services/bronco-before.jpg"
              after="/images/services/bronco-after.jpg"
              beforeAlt="Ford Bronco Sport before collision repair at Corey's Auto Body"
              afterAlt="Ford Bronco Sport after collision repair at Corey's Auto Body"
            />
          </div>
        </div>
      </section>
